...
contract PreLiquidation is IPreLiquidation, IMorphoRepayCallback {
    ...
    /// the provided `data`.
    /// @dev With the callback, the collateral can be withdraw before the debt repayment occurs
    /// allowing the liquidator to preliquidate without the need for a flashloan.
